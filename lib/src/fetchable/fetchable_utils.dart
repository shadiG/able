...
Stream<Fetchable<Tuple2<T1, T2>>> combine2FStreams<T1, T2>({required Stream<Fetchable<T1>> s1, required Stream<Fetchable<T2>> s2}) {
  return CombineLatestStream.combine2<Fetchable<T1>, Fetchable<T2>, Fetchable<Tuple2<T1, T2>>>(
    s1, s2, (f1, f2) {
...
Stream<Fetchable<Tuple3<T1, T2, T3>>> combine3FStreams<T1, T2, T3>({required Stream<Fetchable<T1>> s1, required Stream<Fetchable<T2>> s2, required Stream<Fetchable<T3>> s3}) {
  return CombineLatestStream.combine3<Fetchable<T1>, Fetchable<T2>, Fetchable<T3>, Fetchable<Tuple3<T1, T2, T3>>>(
    s1, s2, s3, (f1, f2, f3) {
...
Stream<Fetchable<Tuple4<T1, T2, T3, T4>>> combine4FStreams<T1, T2, T3, T4>({required Stream<Fetchable<T1>> s1, required Stream<Fetchable<T2>> s2, required Stream<Fetchable<T3>> s3, required Stream<Fetchable<T4>> s4}) {
  return CombineLatestStream.combine4<Fetchable<T1>, Fetchable<T2>, Fetchable<T3>,Fetchable<T4>, Fetchable<Tuple4<T1, T2, T3, T4>>>(
...
Stream<Fetchable<Tuple5<T1, T2, T3, T4, T5>>> combine5FStreams<T1, T2, T3, T4, T5>({required Stream<Fetchable<T1>> s1, required Stream<Fetchable<T2>> s2, required Stream<Fetchable<T3>> s3, required Stream<Fetchable<T4>> s4, required Stream<Fetchable<T5>> s5}) {
  return CombineLatestStream.combine5<Fetchable<T1>, Fetchable<T2>, Fetchable<T3>,Fetchable<T4>, Fetchable<T5>, Fetchable<Tuple5<T1, T2, T3, T4, T5>>>(
...
Stream<Fetchable<Tuple6<T1, T2, T3, T4, T5, T6>>> combine6FStreams<T1, T2, T3, T4, T5, T6>({required Stream<Fetchable<T1>> s1, required Stream<Fetchable<T2>> s2, required Stream<Fetchable<T3>> s3, required Stream<Fetchable<T4>> s4, required Stream<Fetchable<T5>> s5, required Stream<Fetchable<T6>> s6}) {
  return CombineLatestStream.combine6<Fetchable<T1>, Fetchable<T2>, Fetchable<T3>,Fetchable<T4>, Fetchable<T5>, Fetchable<T6>, Fetchable<Tuple6<T1, T2, T3, T4, T5, T6>>>(
    s1, s2, s3, s4, s5, s6, (f1, f2, f3, f4, f5, f6) {
      return combine6F(f1: f1, f2: f2, f3: f3, f4: f4, f5: f5, f6: f6);
    },
  );
}

Stream<Fetchable<Tuple7<T1, T2, T3, T4, T5, T6, T7>>> combine7FStreams<T1, T2, T3, T4, T5, T6, T7>({required Stream<Fetchable<T1>> s1, required Stream<Fetchable<T2>> s2, required Stream<Fetchable<T3>> s3, required Stream<Fetchable<T4>> s4, required Stream<Fetchable<T5>> s5, required Stream<Fetchable<T6>> s6 , required Stream<Fetchable<T7>> s7}) {
  return CombineLatestStream.combine7<Fetchable<T1>, Fetchable<T2>, Fetchable<T3>,Fetchable<T4>, Fetchable<T5>, Fetchable<T6>, Fetchable<T7>, Fetchable<Tuple7<T1, T2, T3, T4, T5, T6, T7>>>(
    s1, s2, s3, s4, s5, s6, s7, (f1, f2, f3, f4, f5, f6, f7) {
